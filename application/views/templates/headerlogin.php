...
li a {
  ...
  text-decoration: none;
    ...
    <body>
<nav class="mb-4 navbar navbar-expand-lg grey">
     <div class="navbar-header">
     <body style="padding-top:0; background-color: yellow">    
          <a style="color:#00FFFF" class="navbar-brand" > Autoservis FastCar</a>
    </div>
